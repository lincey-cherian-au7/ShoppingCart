        ...
        return (
            ...
            <Zoom>
              ...
              <div className="order-details">
                <h3 className="success-message">Your order has been placed sucessfully.</h3>
                ...
                <ul>
                  ...
                  <li>
                    <div>Date :</div>
                    <div>{new Date(order.createdAt).toLocaleDateString('en-GB')},{(new Date(order.createdAt)).toLocaleTimeString('en-GB')}</div>
                  </li>
                  <li>
                    <div>Total :</div>
...
export default connect((state)=>({order:state.order.order,cartItems:state.cart.cartItems}),{removeFromCart,createOrder,clearOrder}
)(Cart)
